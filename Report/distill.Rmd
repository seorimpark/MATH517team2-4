...
```{r pichart, fig.cap = "Categorisation of the multiple type of occurrences",echo=FALSE}
...
pie (c(1,0))
legend("right", legend = c("Accident", "Serious Incident"), fill = c("white", "cadetblue3"),title = "Classification", cex = 1.2)
```
...
incident <- c("take off", "during flight", "landing", "on the ground", "unknown")
...
```{r pichart2,fig.cap = "Pie charts of the damage level depending on the classification", echo=FALSE}
par(mfrow=c(1,2))
...
pie (c(1,0))
legend("right", c("destroyed", "substantial", "light", "none", "unknown"), cex = 1 ,fill = rainbow(5))
```
