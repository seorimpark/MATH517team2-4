...
We notice the same thing again ... 

Table 2 represents the ten cities with the most accidents. 
...
The observation remains the same: these are the largest cities in Brazil, each having the largest airports in the country with the most air traffic.  
