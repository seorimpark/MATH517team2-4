...
stargazer(external, type = "html", title = "Table 1: Accidents not reprensented on the previous map by country")
...
We still notice the same thing, that is to say a concentration of accidents in the Southeast Region of Brazil. This is explained by the fact that the traffic there is the most dense, as this article confirms in particular [@airtraffic]. It turns out that some cities are noteworthy in terms of the number of accidents. Table 2 represents the ten cities with the most accidents. 

```{r, results='asis', echo=FALSE}

stargazer(cities, type = "html", title = "Table 2: Top ten cities with the highest number of accidents")

```

A demographic explanation is still reasonable. The first six cities in Table 2 are among the ten most populous cities in Brazil [@cities]. Moreover, they also have airports on the list of the 20 busiest airports in Brazil [@airports]. 
